...
public class BookingCreated extends AbstractEvent {
    ...
    public String getBookingUsesrId() {
        return bookingUsesrId;
    }

    public void setBookingUsesrId(String bookingUsesrId) {
        this.bookingUsesrId = bookingUsesrId;
    }
}